...
/* num 1 can only be values 2 through 9. It cannot equal 1 or 10, only the numbers between these two values. 
num2 can equal the value 1 through 10. It includes the constraints*/ 
...
const myAnswerForExercise10 = "string data";

// Exercise 11. What is the data type of the value stored in 'product',
// place your answer in the quotes below:

const myAnswerForExercise11 = "an integer";

// Exercise 12. What do you think the value of emptyVariable is?
// Place your answer below:

const myAnswerForExercise12 = "it is undefined because ti doesnt have an assigned value";
...
// A + B * 2 + D + C / 2:
const myAnswerForExercise15 = "3";

// Exercise 16 What is the value of A * B
const myAnswerForExercise16 = "1";

// Exercise 17 What is the value of true || false
const myAnswerForExercise17 = "both true and false are operators. they are used in boolean logic.";

// Exercise 18 What is the value of 1 === "1"
const myAnswerForExercise18 = "result will be false because the second value is a string not an integer";

// Exercise 19 What is the value of 1 == "1"
const myAnswerForExercise19 = "true because the == operator is not as strict as ===";
...
//I was able to retain most of what i learned from freecodebootcamp.com but i did refrence these links.
// https://devmountain.com/blog/what-are-data-types-javascript-101/#:~:text=In%20Javascript%2C%20there%20are%20five,a%20single%20type%20of%20data.
